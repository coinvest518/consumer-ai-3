    ...
    <header className="border-b bg-white/80 backdrop-blur-sm sticky top-0 z-40">
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          <Link to="/tradelines" className="text-gray-600 hover:text-primary transition-colors">Tradelines</Link>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-t bg-white px-4 py-4 space-y-4">
          <nav className="flex flex-col gap-3">
            ...
            <Link to="/tradelines" className="text-gray-600 hover:text-primary" onClick={() => setMobileMenuOpen(false)}>Tradelines</Link>
